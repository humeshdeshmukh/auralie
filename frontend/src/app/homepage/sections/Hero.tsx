          ...
          <div className="text-center lg:text-left space-y-6 relative z-10">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start pt-2">
              <button 
                ...
                disabled={isLoading}
                className={`group relative overflow-hidden bg-primary hover:bg-primary/90 text-white font-medium py-4 px-8 rounded-full transition-all duration-300 transform hover:-translate-y-0.5 shadow-lg hover:shadow-xl hover:shadow-primary/20 ${
              ...
              <button 
                ...
                className="group relative overflow-hidden border-2 border-primary/30 hover:border-primary/50 text-primary hover:text-primary/90 font-medium py-[14px] px-8 rounded-full transition-all duration-300 bg-white/50 hover:bg-white/70 backdrop-blur-sm"
              >
